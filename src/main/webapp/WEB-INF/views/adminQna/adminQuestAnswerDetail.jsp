...
<div class="page-main-style">
   <ul>
      ...
      <li>첨부파일 : <a href="adminQuestAnswerFile.do?num=${questAnswerVO.q_num}">${questAnswerVO.q_filename}</a> </li>
   </ul>
   <!-- size=두께 -->
   <hr size="1" width="100%">
   <p id="adminQna_quest">
      <c:if test="${fn:endsWith(questAnswerVO.q_filename,'.jpg') || 
		              fn:endsWith(questAnswerVO.q_filename,'.JPG') ||
		              fn:endsWith(questAnswerVO.q_filename,'.gif') ||
		              fn:endsWith(questAnswerVO.q_filename,'.GIF') ||
		              fn:endsWith(questAnswerVO.q_filename,'.png') ||
		              fn:endsWith(questAnswerVO.q_filename,'.PNG')}">
			<span class="align-center">
				<img src="adminQuestAnswerImageView.do?num=${questAnswerVO.q_num}" style="max-width:500px">
			</span>
		</c:if>
		<br>
