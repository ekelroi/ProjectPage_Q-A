...
<div class="page-main-style">
   ...
   <table border="1" class="qna-detail-mainTable">
            ...
            <tr>
            	<th>첨부파일</th>
            	<td><a href="questAnswerFile.do?num=${questAnswerVO.q_num}">${questAnswerVO.q_filename}</a></td>
            </tr>
   ...
   <p id="qna-question">
	   <c:if test="${fn:endsWith(questAnswerVO.q_filename,'.jpg') || 
			...
			<span class="align-center">
				<img src="questAnswerImageView.do?num=${questAnswerVO.q_num}" style="max-width:500px">
			</span>
		</c:if>
		<br>
